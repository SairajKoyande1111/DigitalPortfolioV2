...
export const projects: Project[] = [
  ...
  },
  {
    ...
    serviceId: "1",
    name: "Malay Damania",
    shortDescription: "Professional personal branding and consulting platform for business growth consultant Malay Damania.",
    fullDescription: "A sophisticated personal branding and consulting platform designed to showcase Malay Damania's 30+ years of expertise in business growth and leadership. The project involved creating a high-performance digital ecosystem that integrates his coaching frameworks, book summaries, and courses into a seamless user journey for entrepreneurs and professionals.",
    imageUrl: "/attached_assets/Screenshot_2026-01-05_at_1.15.52_AM_1767555957565.png",
    galleryImages: [
  ...
  },
  {
    ...
    shortDescription: "Corporate industrial platform for Vora Electric Service, focusing on integrity, innovation, and a 60-year legacy.",
    fullDescription: "A robust corporate ecosystem for Vora Electric Service that bridges their six-decade legacy of integrity with future-ready electrical innovation. The project involved creating a professional, high-impact digital presence that showcases their full-spectrum electrical and energy services, from turnkey installations to advanced green solutions for large-scale enterprises.",
    imageUrl: "/attached_assets/Screenshot_2026-01-05_at_1.53.10_AM_1767558193271.png",
    galleryImages: [
