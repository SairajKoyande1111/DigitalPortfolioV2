...
export const projects: Project[] = [
  ...
  },
  {
    ...
    shortDescription:
      "Visual-rich culinary platform for Sai Krishna, showcasing authentic vegetarian cuisine.",
    fullDescription:
      "A vibrant, appetizing website for Sai Krishna that captures their 10+ year legacy in creative vegetarian cuisine. The project focused on high-quality food photography and intuitive navigation to enhance the restaurant's digital presence and drive customer visits.",
  ...
  },
  {
    ...
    name: "Ramani Fashion",
    shortDescription:
      "Elegant e-commerce inspired showcase for Ramani Fashion's ethnic wear collection.",
    fullDescription:
      "A sophisticated fashion showcase for Ramani, highlighting their diverse ethnic wear collections from Jamdani Paithani to Patch Work. The design emphasizes elegance and clean aesthetics to match the quality of their craftsmanship.",
  ...
  },
  {
    ...
    shortDescription:
      "Authoritative fashion portal for Nikzone, emphasizing power and style.",
    fullDescription:
      "A bold, high-fashion portal for Nikzone that positions the brand as a leader in authoritative attire. The project combined editorial-style layouts with functional product discovery.",
