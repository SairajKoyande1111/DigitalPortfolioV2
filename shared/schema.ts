...
export const projects: Project[] = [
  ...
  },
  {
    ...
    shortDescription:
      "A high-performance digital menu ecosystem for Barrelborn, designed to offer a seamless, contactless, and interactive dining experience.",
    fullDescription:
    ...
    features: [
      "Interactive Visual Menu: High-resolution showcase of Barrelborn's culinary offerings with categorized navigation.",
      "Mobile-First Responsive Design: Optimized for seamless browsing on all smartphone devices, ensuring accessibility at the table.",
      "Contactless Dining Experience: Secure QR-code based access to the digital menu for a safe and modern guest journey.",
      "Real-Time Availability Tracking: Dynamic updates to ensure guests see only current offerings and seasonal specials.",
      "Sophisticated Brand Identity: A digital interface that reflects the contemporary and premium values of Barrelborn.",
      "High-Performance Architecture: Optimized for rapid loading speeds to ensure a smooth, lag-free user experience.",
    ],
    outcomes: [
      "Enhanced Guest Engagement: Significant increase in interactive menu exploration and customer satisfaction.",
      "Improved Operational Efficiency: Reduced reliance on physical menus and streamlined staff-guest interactions.",
      "Premium Brand Positioning: Established a cutting-edge digital presence that aligns with Barrelborn's high standards.",
      "Seamless Scalability: Robust hosting on Hostinger VPS ensuring consistent uptime and high performance.",
    ],
  },
  {
    id: "w-ramani",
  ...
  },
  {
    ...
    name: "Barrelborn Digital Menu",
    shortDescription:
      "Elegant craft-focused digital menu for Barrelborn Dine & Draft.",
    fullDescription:
      "A specialized digital menu for Barrelborn that balances their premium food and craft beer offerings. The design focuses on mood, quality imagery, and easy discovery of their extensive draft selection.",
